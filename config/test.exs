...
for repo <- [
  ...
  config :yt_search, repo,
    database: Path.expand("../db/yt_search_test_search_slots.db", Path.dirname(__ENV__.file)),
    pool_size: 1,
    queue_target: 10000,
    queue_timeout: 10000,
    pool: Ecto.Adapters.SQL.Sandbox
...
for repo <- [
  ...
  config :yt_search, repo,
    database: Path.expand("../db/yt_search_test_thumbnails.db", Path.dirname(__ENV__.file)),
    pool_size: 1,
    queue_target: 10000,
    queue_timeout: 10000,
    pool: Ecto.Adapters.SQL.Sandbox
...
for repo <- [
  ...
  config :yt_search, repo,
    database: Path.expand("../db/yt_search_test_chapters.db", Path.dirname(__ENV__.file)),
    pool_size: 1,
    queue_target: 10000,
    queue_timeout: 10000,
    pool: Ecto.Adapters.SQL.Sandbox
...
for repo <- [
  ...
  config :yt_search, repo,
    database: Path.expand("../db/yt_search_test_sponsorblock.db", Path.dirname(__ENV__.file)),
    pool_size: 1,
    queue_target: 10000,
    queue_timeout: 10000,
    pool: Ecto.Adapters.SQL.Sandbox
...
for repo <- [
  ...
  config :yt_search, repo,
    database: Path.expand("../db/yt_search_test_subtitles.db", Path.dirname(__ENV__.file)),
    pool_size: 1,
    queue_target: 10000,
    queue_timeout: 10000,
    pool: Ecto.Adapters.SQL.Sandbox
...
for repo <- [
  ...
  config :yt_search, repo,
    database: Path.expand("../db/yt_search_test_links.db", Path.dirname(__ENV__.file)),
    pool_size: 1,
    queue_target: 10000,
    queue_timeout: 10000,
    pool: Ecto.Adapters.SQL.Sandbox
